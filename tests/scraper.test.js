...
// data-exp.firprice = crossed-out original ("was") price; -100 means no original price.
// data-exp.secprice = current sale price.
// .productCartItem DOM nodes contain inflated MSRP values and are NOT used.
const FIXTURE_HTML = `
<html><body>
...
describe('parseDeals', () => {
  ...
  test('skips items with firprice=-100 sentinel (no original price)', () => {
    const html = `
      <html><body>
        <div class="sgm_pc" data-exp='{"biz_type":"product","json_param":{"firprice":"-100","secprice":"7.49","skuid":"bad"}}'>
          <a href="/dp/bad/bad"><img alt="No Original Price" src="https://img.joybuy.fr/bad.jpg" /></a>
        </div>
        <div class="sgm_pc" data-exp='{"biz_type":"product","json_param":{"firprice":"100.00","secprice":"60.00","skuid":"good"}}'>
          <a href="/dp/good/good"><img alt="Good Item" src="https://img.joybuy.fr/good.jpg" /></a>
        </div>
      </body></html>
    `;
    const deals = parseDeals(html, 'https://www.joybuy.fr');
    ...
    const html = `
      <html><body>
        <div class="sgm_pc" data-exp='{"biz_type":"product","json_param":{"firprice":"100.00","secprice":"60.00","skuid":"123"}}'>
          <a href="/dp/good/123"><img alt="Good Product" src="https://img.joybuy.fr/good.jpg" /></a>
        </div>
        <div class="sgm_pc">
          <a href="/dp/bad/456"><img alt="No Price Product" src="https://img.joybuy.fr/bad.jpg" /></a>
        </div>
      </body></html>
    `;
    const deals = parseDeals(html, 'https://www.joybuy.fr');
...
describe('parsePrice (via parseDeals)', () => {
    ...
    const html = `
      <html><body>
        <div class="sgm_pc" data-exp='{"biz_type":"product","json_param":{"firprice":"1299.00","secprice":"799.00","skuid":"tv1"}}'>
          <a href="/dp/samsung-tv/tv1"><img alt="Samsung TV" src="img.jpg" /></a>
        </div>
      </body></html>`;
    const deals = parseDeals(html, 'https://www.joybuy.fr');
    expect(deals.length).toBe(1);
  ...
  test('handles decimal prices with cents', () => {
    const html = `
      <html><body>
        <div class="sgm_pc" data-exp='{"biz_type":"product","json_param":{"firprice":"149.99","secprice":"89.99","skuid":"w1"}}'>
          <a href="/dp/watch/w1"><img alt="Watch" src="img.jpg" /></a>
        </div>
      </body></html>`;
    const deals = parseDeals(html, 'https://www.joybuy.fr');
    expect(deals.length).toBe(1);
